...
import tdtu.finalproject.util.PrefManager;
...
public class WelcomeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //layout of all welcome
        mLayouts = new int[]{R.layout.welcome_1, R.layout.welcome_2, R.layout.welcome_3, R.layout.welcome_4};
        addBottomDots(0);
    ...
    public void onClick(View view) {
        if(view.getId() == mBtnSkip.getId())
            launchHomeScreen();
        if(view.getId() == mBtnNext.getId())
            nextPage();
    }
    ...
    private ViewPager.OnPageChangeListener mViewPagerChangeListener = new ViewPager.OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            ...
            //thay đổi "TIẾP" -> "XONG" nếu gặp page cuối
    ...
    //cài đặt chuyển tiếp giữa các nút báo hiệu
